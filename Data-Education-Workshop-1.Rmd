...
output: 
  html_document:
    toc: true #Set table of content to be true
...
```{r}
library(tidyr) # Getting your dataset in a tidy format
library(tidyverse) # Manipulating data
library(lubridate) # library for date manipulatin
library(zoo) # library for date manipulatin
library(maps) # Mapping for 
library(ggplot2) # For visualizations 
library(ggthemes) # Themes for the ggplot visualization 
...
A picture is woorth a thousand words, what are your takings from the visualization above?
