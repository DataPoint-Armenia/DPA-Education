...
#good predictors!
ggplot(diabetes, aes(x=as.factor(class), fill=Polyuria)) + geom_bar()  + xlab("Diabetes Diagnosis") + ylab("Count")
ggplot(diabetes, aes(x=as.factor(class), fill=Polyphagia)) + geom_bar()  + xlab("Diabetes Diagnosis") + ylab("Count")
ggplot(diabetes, aes(x=as.factor(class), fill=Polydipsia)) + geom_bar()  + xlab("Diabetes Diagnosis") + ylab("Count")

#not so good predictors!
ggplot(diabetes, aes(x=as.factor(class), fill=Itching)) + geom_bar()  + xlab("Diabetes Diagnosis") + ylab("Count")
ggplot(diabetes, aes(x=as.factor(class), fill=delayed.healing)) + geom_bar()  + xlab("Diabetes Diagnosis") + ylab("Count")
...
ggplot(data, aes(x=cholesterol, y=sbp)) + geom_point()  + xlab("Cholesterol") + ylab("Systolic Blood Pressure") + geom_smooth(method=lm)
ggplot(data, aes(x=age, y=sbp)) + geom_point()  + xlab("Cholesterol") + ylab("Systolic Blood Pressure") + geom_smooth(method=lm)
...
```{r}
ggplot(data, aes(x=wt82, y=sbp)) + geom_point()  + xlab("Weight") + ylab("Systolic Blood Pressure") + geom_smooth(method=lm)
ggplot(data, aes(x=as.factor(hbp), y=sbp)) + geom_boxplot()  + xlab("High Blood Pressure in 1971") + ylab("SBP in 1982")
ggplot(data, aes(x=as.factor(hbpmed), y=sbp)) + geom_boxplot()  + xlab("High Blood Pressure Meds in 1971") + ylab("SBP in 1982")
