...
If you're brand new to R, **welcome** recommend you check out [RSwirl](https://swirlstats.com/students.html) if you haven't already to learn how to set up R and learn some of the basics! 
...
predict(logistic_model_2, newdata = new_data_2, type="response")
```
